...
- [x] **T01: Standardize Blazor production API base URL** `est:45m`
...
- [x] **T02: Classify API failures in SurfacesService** `est:1.5h`
...
- [x] **T03: Render actionable Blazor failure states** `est:1h`
...
- [x] **T04: Test Blazor API failure classification** `est:1.5h`
