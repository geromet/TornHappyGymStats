...
- [x] **T01: Move container deploy onto shared config** `est:1.5h`
...
- [x] **T02: Add shared deploy preconditions** `est:2h`
...
- [x] **T03: Wire deploy flow to production smoke** `est:1h`
...
- [x] **T04: Categorize manual and diagnostic ops scripts** `est:1h`
...
- [x] **T05: Add deployment script contract verifier** `est:45m`
