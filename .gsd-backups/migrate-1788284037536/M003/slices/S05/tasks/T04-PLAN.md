...
# T04: Added an optional container-health phase to production smoke that reports Postgres/Keycloak running-health vs docker-access-unavailable states without exposing secrets.
