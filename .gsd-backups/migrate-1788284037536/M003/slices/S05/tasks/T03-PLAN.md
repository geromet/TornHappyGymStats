...
# T03: Added production smoke HTTP-route phase covering API health/surfaces, Blazor home, and AdminPanel health/auth-boundary checks with safe failure excerpts.
