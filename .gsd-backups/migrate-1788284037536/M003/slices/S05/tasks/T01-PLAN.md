...
# T01: Created scripts/verify/production-smoke.sh as a read-only production smoke framework with shared phase/result helpers, local/remote execution mode, and deterministic required-vs-optional exit semantics.
