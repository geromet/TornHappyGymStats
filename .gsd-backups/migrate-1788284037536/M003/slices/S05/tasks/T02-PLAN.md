...
# T02: Added a services phase to production smoke that checks systemd unit state, nginx syntax, and required listener ports with explicit failure classification.
