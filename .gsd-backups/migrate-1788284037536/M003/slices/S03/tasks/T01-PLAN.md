...
# T01: Defined a least-privilege AdminPanel sudoers boundary with explicit steady-state vs bootstrap-only commands and documented it in deployment guidance.
