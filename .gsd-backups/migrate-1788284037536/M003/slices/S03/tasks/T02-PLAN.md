...
# T02: Added an idempotent AdminPanel server setup script that stages and installs the systemd unit, reloads/enable-starts the service, and verifies /admin/health with named fail-fast phases.
