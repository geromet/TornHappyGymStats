...
- [x] **T01: Choose and wire Postgres test harness** `est:45m`
...
- [x] **T02: Add Postgres API startup health test** `est:2h`
...
- [x] **T03: Cover surfaces endpoint under Postgres** `est:1.5h`
...
- [x] **T04: Clarify SQLite test scope** `est:45m`
...
- [x] **T05: Add Postgres integration verifier and docs** `est:45m`
