...
- [x] **T01: Decide AdminPanel nginx route ownership** `est:45m`
...
- [x] **T02: Add AdminPanel nginx upstream config** `est:1.25h`
...
- [x] **T03: Install and validate AdminPanel nginx route** `est:1.5h`
...
- [x] **T04: Add AdminPanel route and auth smoke checks** `est:1h`
