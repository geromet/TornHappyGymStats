...
- [x] **T01: Update README current-state summary** `est:45m`
...
- [x] **T02: Refresh architecture overview** `est:1h`
...
- [x] **T03: Rewrite setup and deployment docs** `est:2h`
...
- [x] **T04: Update API HTTP examples** `est:45m`
...
- [x] **T05: Add docs current-state drift verifier** `est:1h`
