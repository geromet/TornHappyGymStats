...
- [x] **T01: Document .NET SDK and runtime contract** `est:45m`
...
- [x] **T02: Add runtime preflight checks** `est:1h`
...
- [x] **T03: Pin or document package restore policy** `est:1.5h`
...
- [x] **T04: Add runtime reproducibility verifier** `est:45m`
