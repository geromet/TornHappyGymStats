...
- [x] **T01: Declare API production environment contract** `est:1h`
...
- [x] **T02: Add backend deploy health gates** `est:1.5h`
...
- [x] **T03: Expose surfaces cache readiness distinctly** `est:1h`
...
- [x] **T04: Add S01 local contract verifier** `est:45m`
