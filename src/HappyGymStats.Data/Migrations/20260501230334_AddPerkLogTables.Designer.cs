...
namespace HappyGymStats.Data.Migrations
{
    ...
    [Migration("20260501230334_AddPerkLogTables")]
    partial class AddPerkLogTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HappyGymStats.Data.Entities.AffiliationEventEntity", b =>
                {
                    ...
                    b.Property<long?>("PositionAfter")
                        .HasColumnType("INTEGER");

                    b.Property<long?>("PositionBefore")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("Scope", "AffiliationId", "OccurredAtUtc");

                    b.ToTable("AffiliationEvents", t =>
                        {
                            t.HasCheckConstraint("CK_AffiliationEvent_Scope", "Scope IN ('faction', 'company')");
                        });
                });
            ...
            modelBuilder.Entity("HappyGymStats.Data.Entities.LogTypeFetchStateEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("LogTypeFetchStates", t =>
                        {
                            t.HasCheckConstraint("CK_LogTypeFetchState_FetchScope", "FetchScope IN ('personal', 'faction', 'company')");

                            t.HasCheckConstraint("CK_LogTypeFetchState_Status", "Status IN ('pending', 'completed')");
                        });
                });
