...
verify_require_commands bash env mktemp ln grep rm
...
# dirname is deliberately not provided either: the representative verifier no
# longer shells out to it (BASH_SOURCE parameter expansion instead), and this
# restricted PATH should reflect its real dependency set, not a stale one.
